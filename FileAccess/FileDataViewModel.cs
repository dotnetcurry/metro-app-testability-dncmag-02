...
namespace FileAccessDemo
{
    public class FileDataViewModel : INotifyPropertyChanged
    {
        ...
        public FileDataViewModel(IFileRepository fileRepository)
        {
        ...
        {
            FileContent = await fileRepository.GetFileContentAsync(storageFile);
        }

        private async void LoadFiles()
        {
            FilesList = new ObservableCollection<FileItem>(await fileRepository.GetFilesAsync());
        }
    }
}
